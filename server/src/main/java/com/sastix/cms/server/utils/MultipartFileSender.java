...
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromPath(Path path, String contentType) {
        final MultipartFileSender multipartFileSender = new MultipartFileSender().setFilepath(path);
        multipartFileSender.setContentType(contentType);
        return multipartFileSender;
    }
